...
from TTS_lib.vocoder.models.melgan_generator import MelganGenerator
from TTS_lib.vocoder.layers.pqmf import PQMF
...
class MultibandMelganGenerator(MelganGenerator):
    ...
    def inference(self, cond_features):
        ...
        cond_features = torch.nn.functional.pad(
            ...
            'replicate')
        return self.pqmf_layer.synthesis(self.layers(cond_features))
