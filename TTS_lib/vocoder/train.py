...
from TTS_lib.utils.generic_utils import (KeepAverage, count_parameters,
                                     create_experiment_folder, get_git_branch,
                                     remove_experiment_folder, set_init_dict)
from TTS_lib.utils.io import copy_config_file, load_config
from TTS_lib.utils.radam import RAdam
from TTS_lib.utils.tensorboard_logger import TensorboardLogger
from TTS_lib.utils.training import setup_torch_training_env, NoamLR
from TTS_lib.vocoder.datasets.gan_dataset import GANDataset
from TTS_lib.vocoder.datasets.preprocess import load_wav_data
# from distribute import (DistributedSampler, apply_gradient_allreduce,
#                         init_distributed, reduce_tensor)
from TTS_lib.vocoder.layers.losses import DiscriminatorLoss, GeneratorLoss
from TTS_lib.vocoder.utils.io import save_checkpoint, save_best_model
from TTS_lib.vocoder.utils.console_logger import ConsoleLogger
...
def main(args):  # pylint: disable=redefined-outer-name
    ...
    with Pool(5) as p:
        ...
        print(f'Filtered {len(temp_train_data) - len(train_data)} eval instances.')
